...
void solve() {
     ...
     int n;
     cin >> n;
     // so wee neeed to find two integers a and b such that both a>0 and b>0
     // and a+b = n;
     // and the lcm of a and b is the minimum among all possible values of a and b
     // note : inbuilt function s = lcm(a,b)-> this can be used to find lcm of two numbers 
     // so now what we have to do 
     // find all possible value of a and b 
