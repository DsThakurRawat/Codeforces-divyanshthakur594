...
// so basically 
such that beuty is equal to b 
and the sum of element is equal to s 

n - size of array
finding lower bound :)
n = 5 , k ,b,s 
at min. we can have k*b 0 0 0 0 
beuty in that case  will be b
and s will be k*b;
...
void solve() {
    ...
    long long lower_bound = k*b;
    long long upper_bound = (k*b) + (k-1)*n;
