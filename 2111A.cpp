...
the condition will be satisfied when ai >= x
for 
initial lvel of energy for each cystal
a = b = c =0;
// we want three of crystal toreach at x in minimum number of times
analyzing t.c
t.c = o(t)
so it should be solved below
O(nlogn)
// so basically we will increase always cystal which is small in size


 keep contraint ai >= [aj / 2];
 2*ai >= aj;
