...
void MASTER() {
    ...
    0  1    0   1
    0  0    1   0
    in these type of problem we will gonna compaare msb o/p will dopend in msb bcz msb 
    dominates all other terms

    approach cnt case where msb of one term is equal to msb of other for each i ,j;
    ...
    */
        ...
        for(int i = 0;i<n;i++){
            ll msb = 31 - __builtin_clz(v[i]);// find
            cnt[msb]++;
        }
        ll ans = 0;
