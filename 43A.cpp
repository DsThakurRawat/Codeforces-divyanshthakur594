...
int main() {
  ...
  vector<string> strings(
      n); // vector<string> strings(n); → Creates a vector of strings with size
          // n. This will store the n strings the user inputs.
...
*/
  ...
  string maxstr; // string maxstr; → This will store the string that appears the
                 // most times.
  /*int maxfreq=0; → This will store the maximum frequency of any string. It is
   * initialized to 0.
   */
